...
namespace RegisterPersonAPI.Dtos.Requests
{
    ...
    {
        [Required]
        [RegularExpression(@"^ [A - Za - z]{1, 30}$", ErrorMessage = "Name can't be longer than 30 characters and shorter than 1 character.")]
        public string Name { get; set; }
        [Required]
        [RegularExpression(@"^ [A - Za - z]{1, 50}$", ErrorMessage = "Name can't be longer than 50 characters and shorter than 1 character.")]
