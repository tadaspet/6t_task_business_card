    ...
    public partial class NewMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseFaculty", x => new { x.CoursesCourseId, x.FacultiesFacultyId });
                    table.ForeignKey(
                        name: "FK_CourseFaculty_Courses_CoursesCourseId",
                        column: x => x.CoursesCourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseFaculty_Faculties_FacultiesFacultyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseFaculty_FacultiesFacultyId",
                table: "CourseFaculty",
